...
fid1 = fopen('total_SKO.txt', 'w');
fid2 = fopen('random_SKO.txt', 'w');

A=1; %амплитуда сигнала
Q=0.5; %амплитуда шума 0.1 вместо 0.001
...
for NC=6:2:32
    ...
    x=x-mean(x);%для фильтра Чебышёва нужно центрировать входной сигнал!
...
%     title('Сигнал до и после фильтра');%подпись назв ания графика
%     hold off;
