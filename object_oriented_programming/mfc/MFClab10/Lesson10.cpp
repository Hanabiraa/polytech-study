...
// Lesson10.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CLesson10App, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CLesson10App
...
// Единственный объект CLesson10App

CLesson10App theApp;


// Инициализация CLesson10App
